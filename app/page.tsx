          ...
          <div className="container relative z-10">
            <div className="flex flex-col items-center text-center max-w-3xl mx-auto space-y-8">
              ...
              <p className="text-xl text-muted-foreground max-w-2xl">
                Launch your own Solana token in minutes with our no-code
                platform. Customize, deploy, and manage your token without
          ...
          <div className="container">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="glass-effect rounded-lg p-6 text-center relative">
                ...
                <p className="text-muted-foreground">
                  Set your token's name, symbol, supply, and other parameters
